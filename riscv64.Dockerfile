...
# Update apt
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install apt-utils libcurl4 libssl-dev -yqq && DEBIAN_FRONTEND=noninteractive apt-get dist-upgrade -yqq && rm -rf /var/cache/apt/*
